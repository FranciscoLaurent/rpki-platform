...
ALL_PERMISSIONS: list[dict[str, str]] = [
    ...
    {"name": "创建/编辑用户", "code": Permissions.USER_WRITE, "resource": "user", "action": "write"},
    ...
    {"name": "创建/编辑角色", "code": Permissions.ROLE_WRITE, "resource": "role", "action": "write"},
    {"name": "删除角色", "code": Permissions.ROLE_DELETE, "resource": "role", "action": "delete"},
    {"name": "查看权限", "code": Permissions.PERMISSION_READ, "resource": "permission", "action": "read"},
    {"name": "查看租户", "code": Permissions.TENANT_READ, "resource": "tenant", "action": "read"},
    {"name": "创建/编辑租户", "code": Permissions.TENANT_WRITE, "resource": "tenant", "action": "write"},
    {"name": "删除租户", "code": Permissions.TENANT_DELETE, "resource": "tenant", "action": "delete"},
    ...
    {"name": "创建/编辑前缀", "code": Permissions.PREFIX_WRITE, "resource": "prefix", "action": "write"},
    {"name": "删除前缀", "code": Permissions.PREFIX_DELETE, "resource": "prefix", "action": "delete"},
